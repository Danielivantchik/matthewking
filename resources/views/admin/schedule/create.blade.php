        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading"><strong>Add a new event</strong></div>
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{ url('/admin/schedule') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('organizer') ? ' has-error' : '' }}">
                                <input type="text" name="organizer" class="form-control" placeholder="Organizer" value="{{ old('organizer') }}">
                            ...
                            <div class="form-group{{ $errors->has('organizer_website') ? ' has-error' : '' }}">
                                <input type="text" name="organizer_website" class="form-control" placeholder="Organizer Website (https://www.example.com)" value="{{ old('organizer_website') }}">
                            ...
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                <textarea name="address" class="form-control" placeholder="Address and other info" rows=2>{{ old('address') }}</textarea>
